    ...
    <section className="py-28 flex flex-col justify-center items-center gap-28">
      ...
      <div className="relative grid gap-20">
        <div className="relative z-10 grid mx-auto gap-5 text-center max-w-[820px]">
            <h1 className="font-semibold text-5xl text-[#08182E] tracking-tighter">Easily Appointment with patient</h1>
            <p className="text-[#767A85]">An efficient dental appointment is one that is well-organized, minimizes waiting times, and ensures effective communication between the dental team and the patient.</p>
        </div>
        <Image src={AppointmentImg} alt="" width={1006} height={593} className="relative z-10" />
        <Image src={Disc} alt="" width={750} height={750} className="absolute top-14 left-1/2 transform -translate-x-1/2 z-0" />
      </div>
    </section>
  );
}
